...
<head>
    ...
    <!-- icon web -->
    <link href="${pageContext.request.contextPath}/assets/user/image/icon/icon-logo.PNG" rel="shortcut icon" />
    <!-- icon -->
...
<body>
        ...
        <div class="tieude">
                        ...
                        <div class="header__cart-list-sp" id="productList">
                            ...
                            <div class="header__cart-btn">
                                <button class="btn btn-black">
                                    <a href="${pageContext.request.contextPath}/giohang">Xem giỏ hàng
                                    </a>
                                </button>
            ...
            <div class="col10 header-icon">
                <a href="thongtintaikhoan.html">
                    ...
                    <div class="dropdown-content">
                        <a href="${pageContext.request.contextPath}/thongtintaikhoan">Tài khoản của tôi</a>
                         <a href="${pageContext.request.contextPath}/tinhtrangdonhang">Thông tin đơn hàng</a>
    ...
    <nav id="nav_menu">
        <ul class="menu">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/loaikhac">
                    <img src="${pageContext.request.contextPath}/assets/user/image/icon/cuncon-icon.png" alt="cún con">
                    <span>LOÀI KHÁC</span>
                </a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/cachnuoi">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/lienhe">
   ...
   <jsp:include page="${p }"></jsp:include>     
    ...
    <div class="contact-bubbles">
        ...
        <div class="bubbles-phone">
            ...
            <a target="_blank" href="${pageContext.request.contextPath}/lienhe"><img src="${pageContext.request.contextPath}/assets/user/image/icon/phone-con-thongtin.png" alt="icon" /></a>
...
Nhập nội dung
    ...
    <!-- javascript -->
        ...
        <script src="${pageContext.request.contextPath}/assets/user/javascript/style_javascript.js"></script>
         <script src="${pageContext.request.contextPath}/assets/user/javascript/javascript/checkout.js"></script>
