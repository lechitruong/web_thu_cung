              ...
              <div class="card-body">
                ...
                <form method="post" action="${pageContext.request.contextPath}/admin/pet/add">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="input-1" placeholder="Tên sản phẩm" name="pet-name">
                  </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select class="form-control valid" id="input-6" name="category-id" required aria-invalid="false">
...
<%--                        <label for="input-2">Phân loại</label>--%>
<%--                        <div>--%>
<%--                            <select class="form-control valid" id="input-6" name="classify-name" required aria-invalid="false">--%>
<%--                                <option value="1">Chó</option>--%>
<%--                                <option value="2">Mèo</option>--%>
<%--                                <option value="3">Thú cưng khác</option>--%>
<%--                            </select>--%>
<%--                        </div>--%>
<%--                    </div>--%>
	                 <div class="form-group">
                    <label for="input-1">Ngày</label>
                    <input type="text" class="form-control" id="datepicker" placeholder="Ngày đăng" name="pet-day">
                  </div>
	                <div class="form-group">
