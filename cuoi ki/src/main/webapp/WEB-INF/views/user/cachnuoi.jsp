        ...
        <ol class="list-way">
            <li>
                ...
                <div>
                    ...
                    <p>Hệ tiêu hóa của em ý còn non nớt. Những vật dụng cứng như thế có thể khiến em nó bị thủng ruột hoặc tiêu hóa kém đi rất nhiều. Lúc này bạn cứ quẳng cho em nó 1 cục xương ống là được. Em ý vừa có cái mài răng vừa có cái chơi mà lại
                        an toàn nữa.</p>
                    <div class="image-dog">
                        <img src="${pageContext.request.contextPath}/assets/user/image/anhhotro/hinh-nen-nhung-chu-cun-cho-may-tinh-20.jpg" alt="hình ảnh chó con" />
                    </div>
            ...
            <li>
                ...
                <div>
                    ...
                    <p>Thân nhiệt của chó con trong bụng mẹ đã thấp, khi ra ngoài môi trường thì càng thấp hơn. Vì thế thời gian 15 ngày đầu cần chú ý giữ ấm cho em nó bằng rơm, quần áo cũ. Em ý sẽ cố định được thân nhiệt 34,5 đến 36 độ thì sẽ không bị chết
                        lạnh nữa.</p>
                    <div class="image-dog">
                        <img src="${pageContext.request.contextPath}/assets/user/image/anhhotro/anh-chuan-bi-moi-truong-nuoi.jpg" alt="hình ảnh chó con" />
                    </div>
                    ...
                    <div class="image-dog">
                        <img src="${pageContext.request.contextPath}/assets/user/image/anhhotro/cho-me-va-con.jpg" alt="hình ảnh chó con" />
                    </div>
                    <h1>Kỹ thuật nuôi chó con sơ sinh</h1>
                    ...
                    <div class="image-dog">
                        <img src="${pageContext.request.contextPath}/assets/user/image/anhhotro/cho-con-uong-sua.jpg" alt="hình ảnh chó con" />
                    </div>
                    <h1>Giai đoạn chó con được 3- 15 tháng tuổi</h1>
            ...
            <li>
                ...
                <div>
                    ...
                    <div class="image-dog">
                        <img src="${pageContext.request.contextPath}/assets/user/image/anhhotro/3-chu-cho.jpg" alt="hình ảnh chó con" />
                    </div>
                    ...
                    <div class="image-dog">
                        <img src="${pageContext.request.contextPath}/assets/user/image/anhhotro/anh-chu-cun.jpg" alt="hình ảnh chó con" />
                    </div>
            ...
            <li>
                ...
                <div>
                    ...
                    <div class="image-dog">
                        <img src="${pageContext.request.contextPath}/assets/user/image/anhhotro/chu-cun-den-bac-sy.jpg" alt="hình ảnh chó con" />
                    </div>
                    ...
                    <div class="image-dog">
                        <img src="${pageContext.request.contextPath}/assets/user/image/anhhotro/anh-cun-1.jpg" alt="hình ảnh chó con" />
                    </div>
